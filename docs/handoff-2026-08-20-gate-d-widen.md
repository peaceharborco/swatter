...
**STATUS 2026-08-31 14:34 UTC — 48h watch closed, reporting restored.**
`REPEAT_WINDOW_DAYS=30`, `ABUSEIPDB_REPORT=true`, swarm still on. Backups:
...
Numbers and the IPLuo/IA dispositions are in `TODO.md`. The sequence below
is historical — do not re-run the freeze or the knob change.
